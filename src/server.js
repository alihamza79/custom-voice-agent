...
wsserver.listen(HTTP_SERVER_PORT, async function () {
  ...
  console.log("🚀 [SERVER_STARTUP] WebSocket server should be accessible at: wss://21785f194d9a.ngrok-free.app/streams");
  console.log("🚀 [SERVER_STARTUP] Base URL: https://21785f194d9a.ngrok-free.app");
  console.log("🚀 [SERVER_STARTUP] TwiML endpoint: https://21785f194d9a.ngrok-free.app/twiml");
  console.log("🚀 [SERVER_STARTUP] Status callback: https://21785f194d9a.ngrok-free.app/outbound-websocket-call-status");
  console.log("🚀 [SERVER_STARTUP] ==========================================");
  
  // Test WebSocket server accessibility
  console.log("🧪 [WEBSOCKET_TEST] Testing WebSocket server accessibility...");
  const WebSocket = require('ws');
  const testUrl = 'wss://21785f194d9a.ngrok-free.app/streams?streamSid=test_connection&isOutbound=true';
