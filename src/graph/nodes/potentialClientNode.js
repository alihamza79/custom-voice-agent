...
function generatePotentialClientResponse(intent, transcript, language) {
  const responses = {
    english: {
      free_capacity_inquiry: "Great news! We do have availability. Let me transfer you to our team who can help you with scheduling and answer any questions you might have.",
      service_inquiry: "We offer a range of services. Let me transfer you to our team who can provide detailed information about our offerings and pricing.",
      appointment_request: "Perfect! I'd be happy to help you schedule an appointment. Let me transfer you to our booking team.",
    ...
    hindi: {
      free_capacity_inquiry: "Bahut accha! Humare paas availability hai. Main aapko hamare team se connect kar raha hun jo aapki scheduling mein help kar sakte hain.",
      service_inquiry: "Hum various services offer karte hain. Main aapko hamare team se connect kar raha hun jo detailed information de sakte hain.",
      appointment_request: "Perfect! Main aapki appointment schedule karne mein help kar sakta hun. Main aapko booking team se connect kar raha hun.",
    ...
    hindi_mixed: {
      free_capacity_inquiry: "Great! Humare paas availability hai. Let me connect you to our team for scheduling.",
      service_inquiry: "We offer various services. Let me connect you to our team for detailed information.",
      appointment_request: "Perfect! I can help you schedule an appointment. Let me connect you to our booking team.",
      no_intent_detected: "Hello! Thank you for calling. How can I help you today? Are you looking for our services?"
    },
    german: {
      free_capacity_inquiry: "Ausgezeichnet! Wir haben Verfügbarkeit. Lassen Sie mich Sie mit unserem Team verbinden, das Ihnen bei der Terminplanung helfen kann.",
      service_inquiry: "Wir bieten eine Reihe von Dienstleistungen an. Lassen Sie mich Sie mit unserem Team verbinden, das Ihnen detaillierte Informationen geben kann.",
      appointment_request: "Perfekt! Ich helfe Ihnen gerne bei der Terminbuchung. Lassen Sie mich Sie mit unserem Buchungsteam verbinden.",
...
Classify this into one of the 4 categories.`;
    ...
    if (shouldTransferCall) {
      try {
        ...
        // Add transfer message to response
        workflowResponse = `${workflowResponse} I'm transferring you to our team now. Please hold on.`;
        
        // Schedule the actual transfer after a short delay to ensure user hears the response
        setTimeout(async () => {
          try {
        ...
        }, 3000); // 3 second delay to allow TTS to complete
